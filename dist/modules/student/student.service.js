...
const getAllStudent = (params, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
        andConditions.push({
            OR: student_constant_1.searchAbleField.map((field) => ({
                user: {
                    [field]: {
                        contains: searchTerm,
                        mode: "insensitive",
...
exports.studentService = { getAllStudent, getStudentById };
